...
BaseCard {
    ...
    signal showWorkFlowAnnotations()
    ...
    ColumnLayout {
        ...
        Calendar.WeeksView {
            ...
            onSelectedDate: {
                ...
                selectedPage('annotations2/WorkFlowAnnotationsList', {selectedDate: dateStr, filterPeriod: true, interactive: true}, qsTr('Anotacions dins rang de dates'));
            }
            ...
            subWidget: Calendar.DayBase {
                ...
                function dateUpdated() {
                    ...
                    if (annotationsModel.count > 0) {
                        console.log('counttttt', annotationsModel.count);
