...
Common.ThreePanesNavigator {
    ...
    firstPane: Common.NavigationPane {
        ...
        Rectangle {
            ...
            Connections {
                target: galleryBaseItem

                onFolderSelected: galleryItem.folder = folder
            }
    ...
    function openRootChange(folder) {
        setSecondPaneSource('files/FileSelector', {selectDirectory: true, initialDirectory: folder}, {headingText: qsTr('Directoris'), headingColor: 'black'});
    }
}
