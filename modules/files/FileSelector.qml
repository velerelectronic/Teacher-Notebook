...
//            folderList.folder = 'file:///' + (initialDirectory != '')?initialDirectory:paths.documents;
    ...
    function processDocument(document) {
        ...
        case 'png':
        case 'svg':
            fileSelected('ImageMapper',document);
            break;

        case 'json':
            fileSelected('JsonViewer',document);
            break;

        case 'backup':
            fileSelected('DataMan',document);
            break;

        case 'txt':
            fileSelected('TextViewer', document);
            break;

        case 'gxml':
            fileSelected('MultipleGrid', document);
            break;

        case 'md':
            fileSelected('MarkDownViewer', document);
            break;
