...
BasicPage {
    ...
    signal updatedContents()

    function openRubricGroupAssessment(assessment, rubric, rubricsModel, rubricsAssessmentModel) {
        annotationEditor.openPageArgs('RubricGroupAssessment', {assessment: assessment, rubric: rubric, rubricsModel: rubricsModel, rubricsAssessmentModel: rubricsAssessmentModel});
    }
    ...
    property bool updateRubricsList: false
    ...
    mainPage: CollectionInspector {
        ...
        onUpdatedContents: annotationEditor.updatedContents()

        identifier: annotationEditor.identifier
        ...
        Connections {
            ...
            onIdentifierChanged: innerInspector.identifier = annotationEditor.identifier
        }
    ...
    //                bindValues: [annotationEditor.title]
                ...
                Connections {
                    target: annotationEditor
                    onIdentifierChanged: {
                        assessmentsModel.bindValues = [annotationEditor.identifier];
                            ...
                            GridView {
                                ...
                                delegate: Common.BoxedText {
                                    ...
                                    MouseArea {
                                        ...
                                        onClicked: {
                                            closeMenu();
                                            addRubricMenuRect.newRubricAssessment(model.title, model.desc, model.id, singleRubricXGroup.group, annotationEditor.identifier);
                                        }
                                    }
                                }
                            }
